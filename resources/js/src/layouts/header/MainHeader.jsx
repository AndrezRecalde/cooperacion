import {
  ...
  import { Logo } from "../../assets/images/logo/._logo";
    ...
    return (
      <Header height={62} className={classes.header} mb={120}>
        <div className={classes.inner}>
          ...
          <Group>
            <ActionIcon variant="default" onClick={() => toggleColorScheme()} size={34} radius="md">
                {colorScheme === 'dark' ? <IconSunHigh stroke={1.5} size="1.3rem" /> : <IconMoon stroke={1.5} size="1.3rem" />}
            </ActionIcon>
            <User />
