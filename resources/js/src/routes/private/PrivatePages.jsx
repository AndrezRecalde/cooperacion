        ...
        <HomePage>
            <Container size="xl">
                <Routes>
                    ...
                    <Route
                        path="/admin/tipos/cooperaciones"
                        element={<TiposCoopPage />}
                    />

                    <Route
                        path="/admin/tipos/modalidades"
                        element={<ModalidadesPage />}
                    />

                    <Route
                        path="/admin/afiliados"
                        element={<AfiliacionAdmin />}
                    />
                    ...
                    <Route
                        path="/admin/tipos/organizaciones"
                        element={<TipoPage />}
                    />

                    <Route
                        path="/admin/referencias/internacionales"
                        element={<InternacionalPage />}
                    />
                </Routes>
            </Container>
        </HomePage>
